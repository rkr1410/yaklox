...
class ExprPrinter {
    ...
    private fun t(expr: Expression.Ternary): String {
        return "(?: ${stringify(expr.condition)} ${stringify(expr.ifBranch)} ${stringify(expr.elseBranch)})"
    }
